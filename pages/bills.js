...
const Bills = () => {
  ...
  const [loading_charges, setloading_charges] = useState("");
  const [packing_charges, setpacking_charges] = useState("");
  const [unloading_charges, setunloading_charges] = useState("");
  const [stationary_charges, setstationary_charges] = useState("");
  const [actual_weight, setactual_weight] = useState("");
  const [charged_weight, setcharged_weight] = useState("");
  ...
  const editBill = (props) => {
    ...
    setigst(props.igst);
    setsgst(props.sgst);
    setloading_charges(props.loading_charges);
    setpacking_charges(props.packing_charges);
    setunloading_charges(props.unloading_charges);
    setstationary_charges(props.stationary_charges);
    setactual_weight(props.actual_weight);
    setcharged_weight(props.charged_weight);
  ...
  const handleChange = (e) => {
    ...
    else if (e.target.name == "loading_charges")
      setloading_charges(e.target.value);
    else if (e.target.name == "packing_charges")
      setpacking_charges(e.target.value);
    else if (e.target.name == "unloading_charges")
      setunloading_charges(e.target.value);
    else if (e.target.name == "stationary_charges")
      setstationary_charges(e.target.value);
    else if (e.target.name == "actual_weight") setactual_weight(e.target.value);
    else if (e.target.name == "charged_weight")
      setcharged_weight(e.target.value);
              ...
              <form id="myForm" className="max-w-lg mx-auto p-6">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    value={stationary_charges}
                  />
                </div>
                <div className="mb-4">
                  <label
                    className="block font-semibold mb-2"
                    htmlFor="actual_weight"
                  >
                    Actual Weight
                  </label>
                  <input
