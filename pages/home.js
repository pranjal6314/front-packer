...
const Home = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    document.getElementById("unloading_charges").value = "";
    document.getElementById("stationary_charges").value = "";
  ...
  return (
    <>
      ...
      <form id="myForm" className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-4">
          <label className="block font-semibold mb-2" htmlFor="loading_charges">
            Loading Charges
          </label>
          <input
            className="w-full px-3 py-2 border rounded"
        ...
        <div className="mb-4">
          <label className="block font-semibold mb-2" htmlFor="packing_charges">
            Packing Charges
          </label>
          <input
            className="w-full px-3 py-2 border rounded"
        ...
        <div className="mb-4">
          <label className="block font-semibold mb-2" htmlFor="actual_weight">
            Actual Weight
          </label>
          <input
            className="w-full px-3 py-2 border rounded"
        ...
        <div className="mb-4">
          <label className="block font-semibold mb-2" htmlFor="charged_weight">
            Charged weight
          </label>
          <input
            className="w-full px-3 py-2 border rounded"
                 ...
                 <td className="border px-4 py-2">
                  ...
                  <td className="border px-4 py-2">
                    <input
                      type="text"
                      className="w-full px-2 py-1 border rounded"
                      value={row.stationary_charges}
                      onChange={(e) =>
                        handleChange(index, "stationary_charges", e.target.value)
                      }
                    />
                  </td>
                  <td className="border px-4 py-2">
